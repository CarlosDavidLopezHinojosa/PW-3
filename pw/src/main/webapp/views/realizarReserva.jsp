...
document.addEventListener("DOMContentLoaded", function() {
    var contextPath = document.getElementById("hiddenPath").innerText;
    ...
    function buscarPistasDisponibles() {
        ...
        if (tipoReserva && diaYHora && duracion) {
            ...
            var url = contextPath + "/realizarReserva?action=buscarPistasDisponibles&tipoReserva=" + tipoReserva + "&diaYHora=" + diaYHora + "&duracion=" + duracion;
            if (esBono && idBono) {
                url += "&idBono=" + idBono;
            }
    ...
    function buscarBonosDisponibles() {
        ...
        if (tipoReserva) {
            var xhr = new XMLHttpRequest();
            xhr.open("GET", contextPath + "/realizarReserva?action=buscarBonosDisponibles&tipoReserva=" + tipoReserva, true);
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200) {
